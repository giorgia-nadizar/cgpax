...
def _update_buffer(buffer_idx: int,
    ...
    buffer = buffer.at[buffer_idx].set(control_function_switch(f_idx, x_arg, y_arg) * weight)
...
def _update_register(row_idx: int, carry: Tuple[
    ...
    register = register.at[lhs_idx].set(control_function_switch(f_idx, x_arg, y_arg) * weight)
